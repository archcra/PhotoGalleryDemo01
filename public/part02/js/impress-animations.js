(function ( document, window ) {
    ...
    document.addEventListener("impress:init", function (event) {
	    ...
	    var clearAutoSwitch = function (event) {
	    ...
	    document.addEventListener("impress:stepleave", clearAutoSwitch, false);
	    document.addEventListener("impress:substepleave", clearAutoSwitch, false);
