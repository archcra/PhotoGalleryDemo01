var Clay=(
	function(){
		var g='function';
		var j='string';var k=Math.sin;var n=Math.cos;var o=Math.sqrt;
		var $={
			namespace:function(a,b){
				var c=a.split('.');var l=c.length;var d=this;
				for(var i=0;i<l;i++){
					var e=c[i];
					var f=i===(l-1);if(f){d[e]=b}d=d[e]}}};
					Function.prototype.bind=function(a){
						var b=this;return function(){
							return b.apply(a,arguments)}};
							var p={extend:function(a,constructor,b){var c=function(){a.apply(this,arguments);
								if(constructor){constructor.apply(this,arguments)}};this.implement(c,a.prototype);
